...
class InAppWebViewController {
  ...
  Future<dynamic> handleMethod(MethodCall call) async {
    switch (call.method) {
      ...
      case "onZoomScaleChanged":
        if ((_webview != null &&
                // ignore: deprecated_member_use_from_same_package
                (_webview!.androidOnScaleChanged != null || _webview!.onZoomScaleChanged != null)) ||
            _inAppBrowser != null) {
      ...
      case "onExitFullscreen":
        ...
        break;
      case "onOverScrolled":
        if ((_webview != null && _webview!.onOverScrolled != null) || _inAppBrowser != null) {
          int x = call.arguments["x"];
          int y = call.arguments["y"];
      ...
      case "onCallJsHandler":
        ...
        switch (handlerName) {
          ...
          case "onInjectedScriptLoaded":
            ...
            if ((_webview != null || _inAppBrowser != null) && onLoadCallback != null) {
              onLoadCallback();
            }
            return null;
          case "onInjectedScriptError":
            ...
            if ((_webview != null || _inAppBrowser != null) && onErrorCallback != null) {
              onErrorCallback();
            }
            return null;
        }
  ...
  Future<String?> getHtml() async {
    ...
    var webviewUrl = await getOriginUrl();
    if (webviewUrl == null) {
      return html;
    }
...
"""))?.cast<Map<dynamic, dynamic>>() ?? [];
  ...
  Future<void> loadUrl({required URLRequest urlRequest, @Deprecated('Use `allowingReadAccessTo` instead') Uri? iosAllowingReadAccessTo, Uri? allowingReadAccessTo}) async {
    assert(urlRequest.url != null && urlRequest.url.toString().isNotEmpty);
    assert(iosAllowingReadAccessTo == null || iosAllowingReadAccessTo.isScheme("file"));

    Map<String, dynamic> args = <String, dynamic>{};
    args.putIfAbsent('urlRequest', () => urlRequest.toMap());
    args.putIfAbsent('allowingReadAccessTo', () => allowingReadAccessTo?.toString() ?? iosAllowingReadAccessTo?.toString());
  ...
  Future<void> loadData(
    ...
    args.putIfAbsent('historyUrl', () => historyUrl?.toString() ?? androidHistoryUrl?.toString() ?? "about:blank");
    args.putIfAbsent('allowingReadAccessTo', () => allowingReadAccessTo?.toString() ?? iosAllowingReadAccessTo?.toString());
  ...
  Future<String> getTRexRunnerHtml() async {
    return await rootBundle.loadString("packages/flutter_inappwebview/assets/t_rex_runner/t-rex.html");
  }
  ...
  Future<String> getTRexRunnerCss() async {
    return await rootBundle.loadString("packages/flutter_inappwebview/assets/t_rex_runner/t-rex.css");
  }
  ...
  Future<void> zoomBy({required double zoomFactor, @Deprecated('Use `animated` instead') bool? iosAnimated, bool animated = false}) async {
...
(function() {
  ...
  Future<WebMessageChannel?> createWebMessageChannel() async {
    Map<String, dynamic> args = <String, dynamic>{};
    Map<String, dynamic>? result = (await _channel.invokeMethod('createWebMessageChannel', args))?.cast<String, dynamic>();
